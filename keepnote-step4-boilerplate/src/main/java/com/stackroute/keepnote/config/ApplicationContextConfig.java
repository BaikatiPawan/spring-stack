...
public class ApplicationContextConfig {
	...
	public DataSource dataSource() {
		 ...
		 * "jdbc:mysql://mysql:3306/keepnote_dbtest?createDatabaseIfNotExist=true&verifyServerCertificat=false&useSSL=false&requireSSL=false"
		 ...
		 */
		dataSource.setUrl(
				"jdbc:mysql://localhost:3306/usttestdb?createDatabaseIfNotExist=true&allowPublicKeyRetrieval=true&verifyServerCertificate=false&useSSL=false&requireSSL=false");
