...
public class ReminderController {
	...
	public ResponseEntity<?> createReminder(@RequestBody Reminder reminder) {
		try {
			...
			return new ResponseEntity<>(reminder1, HttpStatus.CREATED);
	...
	public ResponseEntity<?> updateUSer(@PathVariable("id") String reminderId, @RequestBody Reminder reminder) {
		try {
	...
	public ResponseEntity<?> getUserByUserId(@PathVariable("id") String reminderId) {
		try {
